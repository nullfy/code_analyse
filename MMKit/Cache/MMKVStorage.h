...
//@property (nonatomic, readonly) MMKVStorageType type;
...
//
//#pragma mark    -Sava item
//
//- (BOOL)savaItem:(MMKVStorageItem *)item;
//
...
//- (BOOL)removeAllItems;
//
//- (void)removeAllItemsWithProgressBlock:(nullable void(^)(int removeCount, int totalCount))progress endBlock:(nullable void(^)(BOOL error))end;
//
...
//
//- (nullable NSArray<MMKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
//
//- (nullable NSArray<MMKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
//
