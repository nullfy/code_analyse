...
MMSYNTH_DUMMY_CLASS(UIColor_MMAdd)

#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)
void MM_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void MM_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void MM_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void MM_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void MM_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void MM_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void MM_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void MM_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (UIColor *)colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    MM_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (UIColor *)colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    MM_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
- (BOOL)getHue:(CGFloat *)hue
    ...
    MM_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
...
- (BOOL)getCyan:(CGFloat *)cyan
    ...
    MM_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
