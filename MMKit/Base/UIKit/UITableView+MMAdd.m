...
MMSYNTH_DUMMY_CLASS(UITableView_MMAdd)

@implementation UITableView (MMAdd)
...
- (void)clearSelectedRowsAnimated:(BOOL)animated {
    ...
    [indexs enumerateObjectsUsingBlock:^(NSIndexPath *indexPath, NSUInteger idx, BOOL * _Nonnull stop) {
