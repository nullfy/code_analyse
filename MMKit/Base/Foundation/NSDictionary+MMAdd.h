...
- (nullable NSNumber *)numberValueForKey:(NSString *)key default:(NSNumber *)def;
- (nullable NSString *)stringValueForKey:(NSString *)key default:(NSString *)def;


@end

@interface NSMutableDictionary (MMAdd)
